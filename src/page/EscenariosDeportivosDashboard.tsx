        ...
        <div className="content-section" style={{ display: 'block' }}>
          ...
          {comboDataset.length > 0 && (
            <div className="chart-card">
              <ComboBars
                title="Inversión vs Presupuesto Ejecutado - Escenarios Deportivos"
          ...
          <div className="tables-grid">
            {/* Tabla de escenarios deportivos entregados */}
            <div className="table-card">
              <WorksTable
                title="Escenarios Deportivos Entregados"
                works={entregadas}
                type="entregadas"
                maxRows={6}
              />
            ...
            {/* Tabla de escenarios deportivos por entregar */}
            <div className="table-card">
              <WorksTable
                title="Escenarios Deportivos por Entregar"
                works={porEntregar}
                type="porEntregar"
                maxRows={4}
              />
            ...
            {/* Tabla de alertas y riesgos deportivos */}
            <div className="table-card">
              <AlertsTable
                alerts={alertas}
                maxRows={6}
