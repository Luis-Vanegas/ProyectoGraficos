...
// ============================================================================
// COMPONENTE PRINCIPAL DEL DASHBOARD - ESCUELAS INTELIGENTES
// ============================================================================
...
const EscuelasInteligentesDashboard = () => {
  // ============================================================================
  // ESTADOS Y VARIABLES
  // ============================================================================
  ...
  // ============================================================================
  // Filtrar datos específicamente para Escuelas Inteligentes
      ...
      <div className="dashboard-content">
        ...
        {status === 'Cargando...' && (
          <div className="loading-container">
            ...
            <div className="loading-text">
              <h3>Cargando datos de Escuelas Inteligentes...</h3>
              <p>Por favor espera mientras se procesan las instituciones educativas</p>
            </div>
          </div>
        )}
        ...
        <div className="kpis-section">
          <div className="kpis-container">
            ...
            <div className="kpis-grid kpis-row-5">
              <Kpi 
                label="Total escuelas inteligentes" 
                value={k.totalObras} 
                trend="neutral"
              />
              <Kpi 
                label="Inversión tecnología educativa" 
                value={k.invTotal} 
                format="money" 
                abbreviate 
                digits={1}
              ...
              />
              <Kpi 
                label="Escuelas completadas" 
                value={k.entregadas} 
                subtitle={`${Math.round(k.pctEntregadas * 100)}% del total`}
                trend="up"
              />
              <Kpi 
                label="Alertas tecnológicas" 
                value={k.alertas}
        ...
        <div className="map-main-panel">
          ...
          <div className="map-legend">
            <h4>Leyenda por Dependencia - Escuelas Inteligentes:</h4>
...
export default EscuelasInteligentesDashboard;
